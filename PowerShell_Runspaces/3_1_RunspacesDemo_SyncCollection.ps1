...
$SyncedQueue = [System.Collections.Queue]::Synchronized((New-Object System.Collections.Queue)) #Fist In First Out
#endregion
...
1..10 | % {$SyncedQueue.Enqueue($_)}
1..10 | % {$SyncedQueue.Clear()}
1..10 | % {$SyncedQueue.Enqueue($_)}
