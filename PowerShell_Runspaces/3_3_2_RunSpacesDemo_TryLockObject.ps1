    ...
    Do {   
        If ($Jobs.count -gt 0) {
            ...
            While (-Not $LockTaken) {
                ...
                If ($LockTaken) {                      
                    $UIHash.host.ui.WriteVerboseLine('JOBS_RS: Locked Object')              
                    ...
                    $UIHash.host.ui.WriteVerboseLine('JOBS_RS: Unlocked Object') 
                    Start-Sleep -Seconds 1             
                } Else {
                    $UIHash.host.ui.WriteVerboseLine('JOBS_RS: Unable to take lock on object')
                }                
            } 
            If ($Error) {
