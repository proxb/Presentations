...
#endregion Out-LineChart

#region Demo Out-LineChart
$LineChartParams = @{
    Title = 'C: Drive Space Report'
    XAxis = 'DateStamp'
    YAxis1 = 'UsedSpaceGB'
    YAxis2 = 'CapacityGB'
    YAxisTitle = 'SizeGB'
...
import-csv '.\C (OS Disk).csv' |
Out-LineChart @LineChartParams
#endregion Demo Out-LineChart